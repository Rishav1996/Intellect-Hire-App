...
def get_layout_profile(file_upload_var, GEMINI_AI):
  ...
  basic_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'BASIC', basic_info_parser)

  progress_bar.progress(25, 'Extracting contact information...')

  contact_info_parser = get_contact_info_parser()
  contact_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'CONTACT', contact_info_parser)

  progress_bar.progress(38, 'Extracting education information...')

  education_info_parser = get_education_info_parser()
  education_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'EDUCATION', education_info_parser)
  ...
  skill_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'SKILLS', skills_info_parser)

  progress_bar.progress(63, 'Extracting company information...')

  company_info_parser = get_company_info_parser()
  company_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'COMPANY', company_info_parser)
  ...
  award_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'AWARD', award_info_parser)
  ...
  certification_info = generate_basic_results(GEMINI_AI, EXTRACT_PAGES, 'CERTIFICATION',
